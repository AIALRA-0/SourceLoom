...
def load_config():
    ...
    config={"data_dir":os.environ.get("SOURCELOOM_DATA", "data"),
            ...
            "kuafu_fallback_roles":["active_plan"],
            ...
            "active_v2_visual_batch_size":6,"active_v2_plan_source_chars":40000,
            "active_v2_plan_source_objects":256,"active_v2_node_source_chars":30000,
            "active_v2_node_source_objects":256,
