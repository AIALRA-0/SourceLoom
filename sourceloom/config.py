...
def load_config():
    ...
    config={"data_dir":os.environ.get("SOURCELOOM_DATA", "data"),
            ...
            "active_v2_visual_batch_size":6,"active_v2_plan_source_chars":3500,
            "active_v2_plan_source_objects":64,"active_v2_node_source_chars":3000,
            "active_v2_node_source_objects":48,
