...
本轮 9 份真实输入得到 1 份完整自动草稿、1 份部分自动草稿，正式自动成品为 0 份；完整草稿尚未通过全部写作要求，指定独立对话也未返回最终核对意见，详见 [逐份结果与成本](reports/AUTOMATIC_TRIAL.md)
...
4. 再次打开材料，选择「原文对照」查看输入和已有输出，停止的任务仍保留已经产生的草稿
...
模型收到规则不等于已经遵守，正式结果仍要求写作审核与独立原文对照均覆盖当前正文；没有完成核对的内容保持草稿状态
