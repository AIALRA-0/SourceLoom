...
当前已更新教学规划和文件库，收集并接入 24 份真实材料，正式自动成品仍为 0 份；已有自动草稿尚未通过全部要求，详见 [真实输入、输出和独立审核结果](reports/AUTOMATIC_TRIAL.md)
...
4. 再次打开材料，选择「并排对照」查看输入和已有输出，点击右侧段落可在左侧定位对应原文，停止的任务仍保留已经产生的草稿
...
长材料的调用预检、原文定位方式与性能复测见 [本轮改进记录](docs/ITERATION_3.md)
