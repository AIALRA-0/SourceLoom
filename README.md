...
当前已更新阅读性能、工具栏、双向定位与正文编辑器，收集并接入 24 份真实材料，正式自动成品仍为 0 份；DeepSeek 已生成可阅读的真实词条候选，但写作规则尚未全部满足，独立聊天核对仍交付不确定，详见 [最新真实试验与性能对照](docs/ITERATION_6.md)、[工作台更新](docs/ITERATION_4.md) 和 [既有真实试验](reports/AUTOMATIC_TRIAL.md)
...
2. 保存到左侧文件夹，打开材料查看原件
3. 配置生成通道后点击「生成改写正文」，后台保存任务并继续处理，页面可以关闭
